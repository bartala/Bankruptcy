# -*- coding: utf-8 -*-
"""CollectTweets(NewBIUBankruptcy).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/bartala/Bankruptcy/blob/main/CollectTweets(NewBIUBankruptcy).ipynb
"""
